...
import { BusinessImpact, IGame, MAX_TIME_TO_COMPLETE, MIN_TIME_TO_COMPLETE } from "../types/types";
...
const GameSchema = new mongoose.Schema({
  ...
  timeRemaining:{ type: Number, min: MIN_TIME_TO_COMPLETE, max: MAX_TIME_TO_COMPLETE },
})
