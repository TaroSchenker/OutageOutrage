...
router.get('/:gameId', gameController.getGameByIdPopulated);
...
router.delete('/games/:gameId/tasks/:taskId', gameController.removeTaskFromGame);
router.put('/games/:gameId/events/:eventId', gameController.addEventToGame);
router.delete('/games/:gameId/events/:eventId', gameController.removeEventFromGame);
