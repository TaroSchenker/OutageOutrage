...
exports.staff = [
    {
        name: 'API Andy',
        avatarUrl: 'https://raw.githubusercontent.com/TaroSchenker/OutageOutrage/main/client/src/assets/images/staff/BackendDev.png',
    ...
    {
        name: 'React Rachel',
        avatarUrl: 'https://github.com/TaroSchenker/OutageOutrage/blob/main/client/src/assets/images/staff/UIUX.png?raw=true',
        role: types_1.Role.FRONTEND_DEV,
        expertise: types_1.Expertise.JAVASCRIPT,
        ambition: 80,
        loyalty: 5,
        skillLevel: 10,
        resilience: 70,
    ...
    {
        name: 'Testcase Tom',
        avatarUrl: 'https://github.com/TaroSchenker/OutageOutrage/blob/main/client/src/assets/images/staff/Noir_QA.png?raw=true',
        role: types_1.Role.QA,
        expertise: types_1.Expertise.SOFTWARE_TESTING,
        ambition: 20,
        loyalty: 90,
        skillLevel: 30,
        resilience: 20,
